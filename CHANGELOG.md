...
- Change use of 'isPartialPeriod' to 'isLastDayOfMonth' for clarity. Add tests. [`2375911`](https://github.com/DEFRA/water-abstraction-helpers/commit/23759112684530c62526a58d4907d0868bfb7b15)
- Add logic to check if return is for partial period [`d4961eb`](https://github.com/DEFRA/water-abstraction-helpers/commit/d4961ebf8bd85af2b41f2a5e5463a4a4df15a34c)
- Add logic to check if return is for partial period [`f1db838`](https://github.com/DEFRA/water-abstraction-helpers/commit/f1db8384d156a976ab956008c1d2624eb0e8d3d1)
