...
#### [v4.9.2](https://github.com/DEFRA/water-abstraction-helpers/compare/v4.9.1...v4.9.2)

- Allow region 9 in the return ID regex [`#360`](https://github.com/DEFRA/water-abstraction-helpers/pull/360)
- Bump pg from 8.22.0 to 8.23.0 [`#359`](https://github.com/DEFRA/water-abstraction-helpers/pull/359)
- Bump js-yaml from 4.3.0 to 4.3.1 [`#358`](https://github.com/DEFRA/water-abstraction-helpers/pull/358)
- Bump @hapi/hapi from 21.4.9 to 21.4.10 [`#357`](https://github.com/DEFRA/water-abstraction-helpers/pull/357)
- Bump actions/checkout from 7.0.0 to 7.0.1 [`#356`](https://github.com/DEFRA/water-abstraction-helpers/pull/356)
- Bump js-yaml from 4.2.0 to 4.3.0 [`#355`](https://github.com/DEFRA/water-abstraction-helpers/pull/355)
- Bump brace-expansion from 1.1.11 to 1.1.16 [`#354`](https://github.com/DEFRA/water-abstraction-helpers/pull/354)
- Bump actions/setup-node from 6.4.0 to 7.0.0 [`#353`](https://github.com/DEFRA/water-abstraction-helpers/pull/353)
- Bump sonarsource/sonarqube-scan-action from 8.2.0 to 8.2.1 [`#352`](https://github.com/DEFRA/water-abstraction-helpers/pull/352)
- Bump actions/cache from 5.0.5 to 6.1.0 [`#351`](https://github.com/DEFRA/water-abstraction-helpers/pull/351)
- Upgrade Node to version 24 [`#350`](https://github.com/DEFRA/water-abstraction-helpers/pull/350)
- Add cooldown option to dependabot workflow [`#349`](https://github.com/DEFRA/water-abstraction-helpers/pull/349)
- Add an npmrc [`#348`](https://github.com/DEFRA/water-abstraction-helpers/pull/348)
- Add GitHub action dependency-review-action to our CI [`#347`](https://github.com/DEFRA/water-abstraction-helpers/pull/347)
- Bump pg from 8.21.0 to 8.22.0 [`#346`](https://github.com/DEFRA/water-abstraction-helpers/pull/346)
- Bump actions/checkout from 6.0.3 to 7.0.0 [`#345`](https://github.com/DEFRA/water-abstraction-helpers/pull/345)
- Bump @babel/core from 7.19.3 to 7.29.7 [`#343`](https://github.com/DEFRA/water-abstraction-helpers/pull/343)
- Bump js-yaml from 4.1.1 to 4.2.0 [`#342`](https://github.com/DEFRA/water-abstraction-helpers/pull/342)
- Pin GitHub actions to commit SHAs instead of versions [`#341`](https://github.com/DEFRA/water-abstraction-helpers/pull/341)
- Bump joi from 17.13.3 to 17.13.4 [`#340`](https://github.com/DEFRA/water-abstraction-helpers/pull/340)
- Bump @hapi/wreck from 18.1.1 to 18.1.2 [`#339`](https://github.com/DEFRA/water-abstraction-helpers/pull/339)
- Bump auto-changelog from 2.5.1 to 2.6.0 [`#338`](https://github.com/DEFRA/water-abstraction-helpers/pull/338)
- Bump pg from 8.20.0 to 8.21.0 [`#337`](https://github.com/DEFRA/water-abstraction-helpers/pull/337)
- Bump @hapi/hapi from 21.4.8 to 21.4.9 [`#336`](https://github.com/DEFRA/water-abstraction-helpers/pull/336)
- Bump auto-changelog from 2.5.0 to 2.5.1 [`#335`](https://github.com/DEFRA/water-abstraction-helpers/pull/335)
- Bump @hapi/hapi from 21.4.7 to 21.4.8 [`#334`](https://github.com/DEFRA/water-abstraction-helpers/pull/334)
- Bump lodash from 4.17.23 to 4.18.1 [`#333`](https://github.com/DEFRA/water-abstraction-helpers/pull/333)
- Bump handlebars from 4.7.7 to 4.7.9 [`#332`](https://github.com/DEFRA/water-abstraction-helpers/pull/332)
- Bump picomatch from 2.3.1 to 2.3.2 [`#331`](https://github.com/DEFRA/water-abstraction-helpers/pull/331)
- Bump flatted from 3.2.7 to 3.4.2 [`#330`](https://github.com/DEFRA/water-abstraction-helpers/pull/330)
- Bump @hapi/hapi from 21.4.6 to 21.4.7 [`#329`](https://github.com/DEFRA/water-abstraction-helpers/pull/329)
- Bump pg from 8.19.0 to 8.20.0 [`#328`](https://github.com/DEFRA/water-abstraction-helpers/pull/328)
- Bump minimatch from 3.1.2 to 3.1.5 [`#327`](https://github.com/DEFRA/water-abstraction-helpers/pull/327)
- Bump pg from 8.18.0 to 8.19.0 [`#326`](https://github.com/DEFRA/water-abstraction-helpers/pull/326)
- Bump ajv from 6.12.6 to 6.14.0 [`#325`](https://github.com/DEFRA/water-abstraction-helpers/pull/325)
- Bump @hapi/hapi from 21.4.4 to 21.4.6 [`#324`](https://github.com/DEFRA/water-abstraction-helpers/pull/324)
- Bump pg from 8.17.2 to 8.18.0 [`#322`](https://github.com/DEFRA/water-abstraction-helpers/pull/322)
- Bump lodash from 4.17.21 to 4.17.23 [`#321`](https://github.com/DEFRA/water-abstraction-helpers/pull/321)
- Bump pg from 8.17.1 to 8.17.2 [`#320`](https://github.com/DEFRA/water-abstraction-helpers/pull/320)
- Bump pg from 8.17.0 to 8.17.1 [`#319`](https://github.com/DEFRA/water-abstraction-helpers/pull/319)
- Bump pg from 8.16.3 to 8.17.0 [`#318`](https://github.com/DEFRA/water-abstraction-helpers/pull/318)
- Remove auto-merge from our GitHub workflows [`#317`](https://github.com/DEFRA/water-abstraction-helpers/pull/317)
- Bump actions/cache from 4 to 5 [`#316`](https://github.com/DEFRA/water-abstraction-helpers/pull/316)
- Add permissions to scanner workflow [`#315`](https://github.com/DEFRA/water-abstraction-helpers/pull/315)
- Add shai-hulud-detect as a daily workflow [`#314`](https://github.com/DEFRA/water-abstraction-helpers/pull/314)
- Bump actions/checkout from 5 to 6 [`#313`](https://github.com/DEFRA/water-abstraction-helpers/pull/313)
- Bump js-yaml from 4.1.0 to 4.1.1 [`#312`](https://github.com/DEFRA/water-abstraction-helpers/pull/312)
- Bump @hapi/hapi from 21.4.3 to 21.4.4 [`#311`](https://github.com/DEFRA/water-abstraction-helpers/pull/311)
- Bump actions/setup-node from 5 to 6 [`#310`](https://github.com/DEFRA/water-abstraction-helpers/pull/310)
- Remove Snyk [`#309`](https://github.com/DEFRA/water-abstraction-helpers/pull/309)
- Bump actions/setup-node from 4 to 5 [`#308`](https://github.com/DEFRA/water-abstraction-helpers/pull/308)
- Bump @hapi/hapi from 21.4.2 to 21.4.3 [`#307`](https://github.com/DEFRA/water-abstraction-helpers/pull/307)
- Bump actions/checkout from 4 to 5 [`#306`](https://github.com/DEFRA/water-abstraction-helpers/pull/306)
- Switch to using Snyk CLI action in CI [`#305`](https://github.com/DEFRA/water-abstraction-helpers/pull/305)
- Bump @hapi/hapi from 21.4.0 to 21.4.2 [`#304`](https://github.com/DEFRA/water-abstraction-helpers/pull/304)
- Bump pg from 8.16.2 to 8.16.3 [`#303`](https://github.com/DEFRA/water-abstraction-helpers/pull/303)
- Bump dotenv from 16.6.0 to 16.6.1 [`#302`](https://github.com/DEFRA/water-abstraction-helpers/pull/302)
- Bump dotenv from 16.5.0 to 16.6.0 [`#301`](https://github.com/DEFRA/water-abstraction-helpers/pull/301)
- Bump pg from 8.16.1 to 8.16.2 [`#300`](https://github.com/DEFRA/water-abstraction-helpers/pull/300)
- Bump pg from 8.16.0 to 8.16.1 [`#299`](https://github.com/DEFRA/water-abstraction-helpers/pull/299)
- Bump pg from 8.15.6 to 8.16.0 [`#298`](https://github.com/DEFRA/water-abstraction-helpers/pull/298)
- Fix "Build Status" badge [`#297`](https://github.com/DEFRA/water-abstraction-helpers/pull/297)
- Bump pg from 8.15.5 to 8.15.6 [`#296`](https://github.com/DEFRA/water-abstraction-helpers/pull/296)
- Bump pg from 8.15.1 to 8.15.5 [`#295`](https://github.com/DEFRA/water-abstraction-helpers/pull/295)
- Bump pg from 8.14.1 to 8.15.1 [`#294`](https://github.com/DEFRA/water-abstraction-helpers/pull/294)
- Bump dotenv from 16.4.7 to 16.5.0 [`#293`](https://github.com/DEFRA/water-abstraction-helpers/pull/293)
- Bump pg from 8.14.0 to 8.14.1 [`#292`](https://github.com/DEFRA/water-abstraction-helpers/pull/292)
- Bump pg from 8.13.3 to 8.14.0 [`#291`](https://github.com/DEFRA/water-abstraction-helpers/pull/291)
- Bump @hapi/hapi from 21.3.12 to 21.4.0 [`#290`](https://github.com/DEFRA/water-abstraction-helpers/pull/290)
- Bump pg from 8.13.2 to 8.13.3 [`#289`](https://github.com/DEFRA/water-abstraction-helpers/pull/289)
- Bump pg from 8.13.1 to 8.13.2 [`#288`](https://github.com/DEFRA/water-abstraction-helpers/pull/288)

#### [v4.9.1](https://github.com/DEFRA/water-abstraction-helpers/compare/v4.9.0...v4.9.1)

> 27 January 2025

- Stop logging pool low warnings in the log [`#287`](https://github.com/DEFRA/water-abstraction-helpers/pull/287)
- Bump cross-fetch from 4.0.0 to 4.1.0 [`#286`](https://github.com/DEFRA/water-abstraction-helpers/pull/286)
- Replace SonarCloud with SonarQube [`#285`](https://github.com/DEFRA/water-abstraction-helpers/pull/285)
- Bump dotenv from 16.4.5 to 16.4.7 [`#284`](https://github.com/DEFRA/water-abstraction-helpers/pull/284)
- Upgrade node to v22 [`#283`](https://github.com/DEFRA/water-abstraction-helpers/pull/283)
- Bump pg from 8.13.0 to 8.13.1 [`#282`](https://github.com/DEFRA/water-abstraction-helpers/pull/282)
- Bump @hapi/hapi from 21.3.10 to 21.3.12 [`#281`](https://github.com/DEFRA/water-abstraction-helpers/pull/281)
- Bump @hapi/lab from 25.3.1 to 25.3.2 [`#280`](https://github.com/DEFRA/water-abstraction-helpers/pull/280)
- Bump pg from 8.12.0 to 8.13.0 [`#279`](https://github.com/DEFRA/water-abstraction-helpers/pull/279)
- Bump standard from 17.1.1 to 17.1.2 [`#278`](https://github.com/DEFRA/water-abstraction-helpers/pull/278)
- Bump standard from 17.1.0 to 17.1.1 [`#277`](https://github.com/DEFRA/water-abstraction-helpers/pull/277)
- Bump auto-changelog from 2.4.0 to 2.5.0 [`#276`](https://github.com/DEFRA/water-abstraction-helpers/pull/276)
- Bump sinon from 18.0.0 to 18.0.1 [`#275`](https://github.com/DEFRA/water-abstraction-helpers/pull/275)
- Bump @hapi/lab from 25.2.0 to 25.3.1 [`#274`](https://github.com/DEFRA/water-abstraction-helpers/pull/274)
- Bump joi from 17.13.1 to 17.13.3 [`#273`](https://github.com/DEFRA/water-abstraction-helpers/pull/273)
- Bump braces from 3.0.2 to 3.0.3 [`#272`](https://github.com/DEFRA/water-abstraction-helpers/pull/272)
- Bump @hapi/hapi from 21.3.9 to 21.3.10 [`#271`](https://github.com/DEFRA/water-abstraction-helpers/pull/271)
- Bump pg from 8.11.5 to 8.12.0 [`#270`](https://github.com/DEFRA/water-abstraction-helpers/pull/270)
